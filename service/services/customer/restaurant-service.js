...
module.exports = {
    ...
    vendorCategories: (data, callBack) => {
        async.waterfall([
            function(nextCb) {
                restaurantModel.vendorCategories(data, function(result) {
                    nextCb(null, result);
                })
            }
        ], function(err, result) {
    ...
    bannerVendorList: (data, callBack) => {
        async.waterfall([
            function(nextCb) {
                restaurantModel.bannerVendorList(data, function(result) {
                    nextCb(null, result);
                })
            }
        ], function(err, result) {
    ...
    cartOrderValidation: (data, callBack) => {
        async.waterfall([
            function(nextCb) {
                restaurantModel.cartOrderValidation(data, function(result) {
                    nextCb(null, result);
                })
            }
        ], function(err, result) {
    ...
    getCustomerContent: (data, callBack) => {
        async.waterfall([
            function(nextCb) {
                restaurantModel.getCustomerContent(data, function(result) {
                    nextCb(null, result);
                })
            }
        ], function(err, result) {
