...
module.exports = {
    ...
    addVendorTimeValidator: async (req, res, next) => {
        const rules = joi.object({
            ...
            foodSafetyCertificate: joi.string().allow('').optional(),
        });
    ...
    vendorVerifyUser: async (req, res, next) => {
        const appTypeVal = ["ANDROID", "IOS", "BROWSER"];
        const pushType = ["P", "S"];
        const rules = joi.object({
            vendorId: joi.string().required().error(new Error('User id is required')),
            ...
            isLogin: joi.boolean().error(new Error('Is login required'))
        });
    ...
    itemAddValidator: async (req, res, next) => {
        ...
        const rules = joi.object({
            ...
            isImageChange: joi.string().allow('')
        });
    ...
    getVendorContent: async (req, res, next) => {
        const rules = joi.object({
            customerId: joi.string().required().error(new Error('Customer id is required')),
            vendorId: joi.string().required().error(new Error('Vendor id is required')),
